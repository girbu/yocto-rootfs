...
#define __GMP_CC "arm-poky-linux-gnueabi-gcc  -march=armv7-a -mthumb-interwork -mfloat-abi=softfp -mfpu=neon --sysroot=/home/user/yocto2/build/tmp/sysroots/zedboard-zynq7"
